...
var translations = {
  es: {
    ...
    'cat.1.desc': 'Hostales, autoestop y conversaciones con desconocidos',
    ...
    'collabs.body': 'Lo que enseño lo uso de verdad: herramientas que me acompañan a los sitios más remotos del mundo, en contexto real.',
  ...
  en: {
    ...
    'cat.1.desc': 'Hostels, hitchhiking, and conversations with strangers',
    ...
    'collabs.body': "What I show, I actually use: tools that come with me to the most remote places on earth, in real context.",
  ...
  fr: {
    ...
    'cat.1.desc': 'Auberges, auto-stop et conversations avec des inconnus',
    ...
    'collabs.body': "Ce que je montre, je l'utilise vraiment : des outils qui m'accompagnent dans les endroits les plus reculés du monde, en contexte réel.",
  ...
  zh: {
    ...
    'collabs.body': '我展示的，我都真正在用：这些工具陪我走到世界最偏远的角落，真实场景，真实使用。',
    'brand.1': '永远在我腰包里的相机',
